...
public enum Localization {
    ...
    NEW_CLAIM__MAX_SIZE("<red>A claim cannot exceed 40401 blocks (example 201x201)."),
    NEW_CLAIM__BAD_RATIO("<red>The shorter side of your claim must be at least 80% of the longer side"),
    ...
    RESIZE__MAX_SIZE("<red>A claim cannot exceed 40401 blocks (example 201x201)."),
    RESIZE__BAD_RATIO("<red>The shorter side of your claim must be at least 80% of the longer side"),
